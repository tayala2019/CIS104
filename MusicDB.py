	...
	def AddSong():
	  ...
	  while True :
	    if(len(song_title) <=64):
	      ...
	      print("wrong input")
	      song_title = input("Song title cannot exceed 64 chracters  : ")
	  ...
	  while True:
	    if (len(artist) <=32):
	      ...
	      print("wroung input ")
	      artist = input("Artist cannot exceed 32 chracters: ")
	  ...
	  while True :
	    if (len(album) <= 64):
	      ...
	      print("Album cannot exceed 64 characters ")
	      album = input("Enter Album: ")
